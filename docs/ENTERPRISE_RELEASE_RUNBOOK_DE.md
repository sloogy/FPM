# Enterprise-Release-Runbook v1.0.0
...
- Den nächsten freien nummerierten RC-Tag setzen (`v1.0.0-rc.2`). Er startet die echten Windows-/Linux-Builds, den Inno-Setup-Installer und beide LifePlanner-Module ohne Signier-Keys.
...
- `latest.json` verweist exakt auf Tag `v1.0.0` und alle Standalone-/Installer-/LifePlanner-Assets.
...
- Update von der vorherigen stabilen Version auf v1.0.0 testen, inklusive Datenbankbackup und Rollbackdatei.
