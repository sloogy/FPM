...
Die Sammlungsdatenbank traegt Kaufpreise, Haendler und persoenliche Notizen.
...
from logic.file_permissions import (
    OWNER_ONLY_DIR,
    OWNER_ONLY_FILE,
    is_world_accessible,
    secure_dir,
...
@posix_only
def test_die_datenbank_gehoert_nur_dem_eigentuemer(tmp_path):
    from database.db import close_db, init_db

    pfad = tmp_path / "sammlung.db"
    init_db(pfad)
    try:
