...
Die Sammlungsdatenbank enthält Kaufpreise, Händler und persönliche Notizen.
Erzeugt wurde sie bisher mit dem Standard-umask, auf typischen Linux-Systemen
also **0644 (world-readable)**: Auf einem Mehrbenutzer-System konnte jedes
lokale Konto mitlesen, und in einem geteilten Ordner jeder mit Zugriff darauf.
